...
| # |             9 |                4.089 | 1.1565439 |
| # |            10 |                4.095 | 1.1582409 |
#+TBLFM: @3$3=remote(tabSigGen,$srcVol_Vrms)::$4=$V_Meas_Vrms/remote(tabSigGen,$srcVol_Vrms)

#+begin_src octave :exports results :results file :var data=tabCalcSurgeImpedance
...
#end user code
print -dpng chart.png "-S1200,600";
ans = "chart.png";
#+end_src
